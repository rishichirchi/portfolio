...
const Header = () => {
  ...
  return (
    <header className="flex items-center justify-between p-6 lg:px-12 bg-background">
      <Link
        href="/"
        className="text-3xl font-medium bg-gradient-to-r from-foreground to-foreground/30 bg-clip-text text-transparent flex justify-center items-center"
      >
        Rishi Chirchi
      </Link>
      ...
      <nav className="hidden md:flex items-center space-x-4 bg-sidebar border border-border p-2 px-8 rounded-full">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent
            align="end"
            className="w-48 mt-4 bg-card border border-border rounded-lg shadow-lg p-1"
          >
            {/* Socials */}
            {[
              {
