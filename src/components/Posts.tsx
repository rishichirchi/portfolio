...
export default function Posts({ limit = 3, showTitle = true }: PostsProps) {
  ...
  return (
    <section className="px-4 sm:px-6 lg:px-12 py-12 lg:py-24">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-8 lg:mb-16 font-bricolage">
          Recent Posts
        </h2>
            ...
            <article
              ...
              className={
                index < posts.length - 1
                  ? "border-b border-border pb-8 lg:pb-12"
                  : ""
              }
            >
              ...
              <Link href={post.link} target="_blank" rel="noopener noreferrer">
                <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 font-bricolage hover:text-primary transition-colors">
                  {post.title}
                </h3>
              </Link>
        ...
        <div className="mt-8 lg:mt-12">
          <Link
            ...
            className="inline-flex items-center font-medium border border-border hover:bg-accent hover:text-accent-foreground px-4 py-2 rounded transition-colors text-sm sm:text-base"
          >
            VIEW ALL
          </Link>
        </div>
